...
TileInfo::TileInfo(const TileInfo& _RHS) : Component(_RHS),m_bOnlyAnimation(_RHS.m_bOnlyAnimation), m_eNextStage(_RHS.m_eNextStage), m_eTileStage(_RHS.m_eTileStage), m_eTileSide(_RHS.m_eTileSide), m_bPortal(_RHS.m_bPortal),
