...
GameObject::GameObject(LPDIRECT3DDEVICE9 _GRPDEV) : GRPDEV(_GRPDEV), ObjectTAG(L""), ObjectDead(FALSE), ObjectTYPE(), AlphaZValue(0.f)
{
	GRPDEV->AddRef();
	ComponentList.resize((LONG)COMPONENT_TYPE::COMPONENT_END);
};
