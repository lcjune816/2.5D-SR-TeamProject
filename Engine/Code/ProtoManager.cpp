...
HRESULT		ProtoManager::Ready_Prototype(LPDIRECT3DDEVICE9 _GRPDEV) {
	...
	ComponentList.push_back(Buffer		::Create(_GRPDEV, BUFFER_TYPE::TILE));			//COMPONENT_TYPE::COMPONENT_TILE		= 8
	ComponentList.push_back(Buffer		::Create(_GRPDEV, BUFFER_TYPE::CUBE));			//COMPONENT_TYPE::COMPONENT_CUBE		= 9
	ComponentList.push_back(Buffer		::Create(_GRPDEV, BUFFER_TYPE::TILEFRONT));		//COMPONENT_TYPE::COMPONENT_TILEFRONT	= 10
	ComponentList.push_back(Buffer		::Create(_GRPDEV, BUFFER_TYPE::TILELEFT));		//COMPONENT_TYPE::COMPONENT_TILEFRONT	= 11
	ComponentList.push_back(Buffer		::Create(_GRPDEV, BUFFER_TYPE::TILERIGHT));		//COMPONENT_TYPE::COMPONENT_TILEFRONT	= 12
	ComponentList.push_back(Buffer		::Create(_GRPDEV, BUFFER_TYPE::TILEBACK));		//COMPONENT_TYPE::COMPONENT_TILEFRONT	= 13
