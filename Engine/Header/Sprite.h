...
struct ENGINE_DLL SpriteINFO {
	...
	SpriteINFO(CONST TCHAR* _KEY, UINT _WIDTH, UINT _HEIGHT, FLOAT _POSX, FLOAT _POSY, BOOL _VIS, INT _OPACITY = 255, _vec3 _RGB = D3DXVECTOR3(255, 255, 255))
		: KEY(_KEY), WIDTH(_WIDTH), HEIGHT(_HEIGHT),POS{ _POSX, _POSY, 0.f }, OPACITY(_OPACITY), TEXTURE(nullptr), VISIBLE(_VIS), RGBValue(_RGB){}
...
struct ENGINE_DLL ItemINFO {
	enum ITINFO { NAME, CLASS, EFFECT01, EFFECT02, EFFECT03, DESC, EXDESC, INVFRAME, INFFRAME};
