...
struct ENGINE_DLL SpriteINFO {
	...
	SpriteINFO(CONST TCHAR* _PATH, UINT _WIDTH, UINT _HEIGHT, FLOAT _POSX, FLOAT _POSY, BOOL _VIS, INT _OPACITY = 255)
		: PATH(_PATH), WIDTH(_WIDTH), HEIGHT(_HEIGHT),POS{ _POSX, _POSY, 0.f }, OPACITY(_OPACITY), TEXTURE(nullptr), VISIBLE(_VIS){}
...
public:
	...
	HRESULT		Import_Sprite(CONST TCHAR* _PATH, FLOAT _POSX, FLOAT _POSY, UINT _WIDTH, UINT _HEIGHT, BOOL _VIS, INT _OPACITY = 255);
