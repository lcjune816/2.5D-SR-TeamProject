...
namespace Engine
{
	...
	enum class CHANNELID { SOUND_BGM01, SOUND_BGM02, SOUND_BGM03, SOUND_BGM04, SOUND_EFFECT01, SOUND_EFFECT02, SOUND_EFFECT03, SOUND_EFFECT04, SOUND_EFFECT05,
	...
	enum class GAMEOBJECT_TYPE {
		OBJECT_CAMERA,
		OBJECT_PLAYER, BOW, ARROW, ARTIFACT,
		OBJECT_TERRAIN,
