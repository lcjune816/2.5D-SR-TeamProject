...
public:
	...
	enum class DEATH_STAGING	{ SPOOL_APPEAR, SPOOL_FLOW1, SPOOL_FLOW2, SPOOL_FLOW3, SPOOL_FLOW4, SPOOL_FLOW5, SPOOL_FLOW6, 
								  WATER_POPUP1, WATER_POPUP2, WATER_POPUP3, WATER_POPUP4,
								  BIG_FLAME, BIG_CIRCLE_FLAME, ELECTRIC, ENDING };
	...
	enum class FIREBALL			{ ANGLE_GENERATE, FIRST_FIREBALL, SECOND_FIREBALL, THIRD_FIREBALL, FOURTH_FIREBALL, FIFTH_FIREBALL, SIXTH_FIREBALL, END_FIREBALL };
