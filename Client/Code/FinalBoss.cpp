...
HRESULT	FinalBoss::Ready_GameObject()						{
	...
	ObjectTAG = L"Docheol";
	//Invalidate_Mode = TRUE;		// ÇÇÇØ ¹«È¿È­
	Invalidate_Mode = FALSE;		// µð¹ö±ë¿ë
	Action_Mode		= TRUE;		// ´Ù¸¥ Çàµ¿ °£¼· ¹æÁö
	//Action_Mode = FALSE;		// µð¹ö±ë¿ë
	Rage_Mode		= FALSE;	// ÆøÁÖÈ­ ´Ü°è
	//Rage_Mode		= TRUE;	// µð¹ö±ë¿ë
	Death_Mode		= FALSE;	// »ç¸Á ´Ü°è
