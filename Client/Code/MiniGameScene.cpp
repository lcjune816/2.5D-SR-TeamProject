...
HRESULT MiniGameScene::Ready_GameLogic_Layer(){
	...
	Monster::Add_Monster_to_Scene(Monster::Create<Bat>(GRPDEV, { 25.f,1.f,10.f }, { 25.f,1.f,0.f }, 5.f, 2.f), L"Hurdle", GAMEOBJECT_TYPE::OBJECT_HURDLE);
	...
	Monster::Add_Monster_to_Scene(Monster::Create<Bat>(GRPDEV, { 50.f,1.f,5.f }, { 50.f,1.f,5.f }, 6.f, 2.f), L"Hurdle", GAMEOBJECT_TYPE::OBJECT_HURDLE);
	...
	Monster::Add_Monster_to_Scene(Monster::Create<Bat>(GRPDEV, { 65.f,1.f,0.f }, { 60.f,1.f,10.f }, 4.f, 2.f), L"Hurdle", GAMEOBJECT_TYPE::OBJECT_HURDLE);
