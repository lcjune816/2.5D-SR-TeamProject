...
HRESULT MainUI::Component_Initialize() {
	...
	Component_Sprite->Import_Sprite(L"../../Resource/Extra/Example/Skill01.png", 50, 50, 10, 650, 100, TRUE);
	Component_Sprite->Import_Sprite(L"../../Resource/Extra/Example/Skill02.png", 50, 50, 70, 650,TRUE);
	Component_Sprite->Import_Sprite(L"../../Resource/Extra/Example/Skill03.png", 50, 50, 130, 650, TRUE);
