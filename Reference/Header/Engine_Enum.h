...
namespace Engine
{
	...
	enum class COMPONENT_TYPE {
		...
		COMPONENT_TRANSFORM, COMPONENT_TEXTURE, COMPONENT_SPRITE, COMPONENT_COLLIDER, COMPONENT_FSM, COMPONENT_END
	};
	...
	enum class TILE_STATE		{ STATE_NORMAL, STATE_COLLISION, STATE_TRIGGER, STATE_END};
