...
namespace Engine
{
	...
	enum class GAMEOBJECT_TYPE	{ OBJECT_CAMERA, OBJECT_PLAYER, OBJECT_TERRAIN, OBJECT_MONSTER, OBJECT_NPC, OBJECT_UI, OBJECT_MONSTER_BULLET, MONSTER_EFFECT, OBJECT_FINALBOSS, OBJECT_END };
