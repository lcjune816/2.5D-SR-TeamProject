...
namespace Engine
{
	...
	enum class CHANNELID { SOUND_BGM01, SOUND_BGM02, SOUND_BGM03, SOUND_EFFECT01, SOUND_EFFECT02, SOUND_EFFECT03, SOUND_EFFECT04, SOUND_EFFECT05, 
		SOUND_EFFECT06, SOUND_EFFECT07, SOUND_EFFECT08, SOUND_EFFECT09, SOUND_EFFECT10, SOUND_EFFECT11, SOUND_END };

	enum class SCENE_TYPE		{ SCENE_LOGO, SCENE_STAGE, Minigame, SCENE_END };
	...
	enum class COMPONENT_TYPE {
		...
		COMPONENT_TRANSFORM, COMPONENT_TEXTURE, COMPONENT_SPRITE, COMPONENT_COLLIDER, COMPONENT_TILEINFO, COMPONENT_END
	};

	enum class GAMEOBJECT_TYPE {
		OBJECT_CAMERA,
		OBJECT_PLAYER, BOW, ARROW, ARTIFACT, PLAYER_SHADOW, 
		OBJECT_TERRAIN,
		OBJECT_MONSTER, OBJECT_MONSTER_BULLET, MONSTER_EFFECT,
		OBJECT_HURDLE,
		OBJECT_NPC, 
		OBJECT_UI, 
	...
	enum class BULLET_TYPE		: uint8_t { Standard = 0, ScorpionBullet, Chain, Fireball, GroundIce, Chain01, Chain02, FireDevilBowChargeEffect, End };
	enum class FIREDEVILBOWCHARGEEFFECT : uint8_t { Birth = 0, Charge, Death, End };
	...
	////////////////////////////////////////////////////////////////////////////////////
	enum class EFFECT_RENDER { PLAYER_EFFECT, MONSTER_EFFECT, BOSS_FRONT_EFFECT, BOSS_BACK_EFFECT, UI_EFFECT };
	//////////////////////////////////////////////////////////////// Customized
