...
namespace Engine
{
	...
	enum	   TILE_STATE		{STATE_NORMAL, STATE_COLLISION, STATE_TRIGGER, STATE_ANIMATION, STATE_END};
	enum	   TILE_IMAGEPAGE   {TILE_STAGE1, TILE_STAGE2, TILE_STAGE3, TILE_STAGE4, TILE_BOSS, IMAGEPAGE_END}; // class 붙여서 하니까 배열로 선언 안돼서 뺐음
