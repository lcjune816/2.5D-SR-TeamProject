...
namespace Engine
{
	...
	enum class COMPONENT_TYPE	{ COMPONENT_TRIANGLE, COMPONENT_RECTANGLE, COMPONENT_RECTTEX, COMPONENT_TERRAIN, COMPONENT_TRANSFORM,
									COMPONENT_TEXTURE, COMPONENT_SPRITE, COMPONENT_FSM, COMPONENT_TILE, COMPONENT_CUBE, COMPONENT_TILEFRONT,									
								   COMPONENT_TILELEFT, COMPONENT_TILERIGHT, COMPONENT_TILEBACK,
							         COMPONENT_END };
