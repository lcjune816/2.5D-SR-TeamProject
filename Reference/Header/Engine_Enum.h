...
namespace Engine
{
	...
	enum class COMPONENT_TYPE	{ COMPONENT_TRIANGLE, COMPONENT_RECTANGLE, COMPONENT_RECTTEX, COMPONENT_TERRAIN, COMPONENT_TILE, COMPONENT_CUBE,
								  COMPONENT_TILESIDE, COMPONENT_TRANSFORM, COMPONENT_TEXTURE, COMPONENT_SPRITE, COMPONENT_FSM, COMPONENT_END };
	...
	enum class BUFFER_TYPE		{ TRIANGLE, RECTANGLE, TEXTURE, TERRAIN, TILE, CUBE, TILESIDE, END };
